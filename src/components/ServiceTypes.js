  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Types Grid - Desktop */}
        <div className={`hidden lg:flex flex-wrap justify-center gap-8 max-w-7xl mx-auto`}>
          {types.map((type, index) => (
            <div
              key={index}
              className="group relative bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-500 hover:-translate-y-2 w-full lg:w-[calc(33.333%-1.5rem)] lg:max-w-sm"
            >
              {/* Image */}
        ...
        {/* Types Grid - Mobile/Tablet */}
        <div className="lg:hidden flex flex-wrap justify-center gap-6 px-4">
          {types.map((type, index) => (
            <div
              key={index}
              className="group relative bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-500 hover:-translate-y-2 w-full max-w-md"
            >
              {/* Image */}
              <div className="relative h-64 overflow-hidden">
                <div className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-20`}></div>
