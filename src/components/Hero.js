...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-pink-50/30 pt-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              From stunning signage to professional printing, we deliver cutting-edge solutions
              that make your business stand out. Your vision, our expertise.
            </p>
